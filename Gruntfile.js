// Generated on 2015-01-07 using generator-angular-require 0.4.1
'use strict';
...
module.exports = function (grunt) {
	...
	grunt.registerTask('hot', 'Compile', function (target) {
		if (target === 'dist') {
			return grunt.task.run(['build', 'connect:dist:keepalive']);
		}
